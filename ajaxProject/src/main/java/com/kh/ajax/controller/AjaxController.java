...
public class AjaxController {
	...
	*/
	...
	public String ajaxMethod1(String name, int age, HttpServletResponse response) throws IOException {
		...
		//데이터를 이름, 나이 따로 분기해서 보내주고 싶지만 한번에 반환이된다.
//		response.setContentType("text/html; charset=UTF-8");
...
//		response.getWriter().print(jobj);
	...
	*/
	...
	public String ajaxMethod1(String name, int age) {
		...
		list.add(new Member("user02", "pass02", name, age, "01022224444"));
		list.add(new Member("user03", "pass03", "김개똥", 15, "01022224444"));
		list.add(new Member("user04", "pass04", name, age, "01022224444"));
		list.add(new Member("user05", "pass05", name, age, "01022224444"));
